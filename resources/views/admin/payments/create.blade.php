            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <select name="class_room_id" id="class_room_id" class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500" required onchange="updateAmount()">
                        ...
                        @foreach($classRooms as $classRoom)
                            <option value="{{ $classRoom->id }}" data-price="{{ $classRoom->price }}" data-type="{{ $classRoom->type }}" {{ old('class_room_id') == $classRoom->id ? 'selected' : '' }}>
                ...
                <div class="md:col-span-2">
                    ...
                    <input type="file" name="payment_proof" id="payment_proof" 
                           class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500"
                           accept="image/*">
                    <p class="mt-1 text-sm text-gray-500">Upload image file (jpg, png, etc.)</p>
                    @error('payment_proof')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                </div>
